...
class BrowserStorage:
    def __init__(self, base_dir: Path | None = None):
        ...
        preferred = base_dir or (Path(env_dir).expanduser() if env_dir else (Path.home() / ".local" / "share" / "python-browser"))
            ...
            normalized_profiles.append(
                {
                    ...
                    "search_url": str(item.get("search_url", "https://duckduckgo.com/?q={query}"))
                    or "https://duckduckgo.com/?q={query}",
                }
            )
